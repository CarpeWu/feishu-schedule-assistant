# feishu-nodes-lite 社区节点功能文档 v1.3.0
...
**版本**: 1.3.0
**发布日期**: 2025-12-11
**适用范围**: `智能日程与效能管理系统 v1.3.0` 项目及类似 n8n-Feishu 集成场景。
...
*   **v1.3.0 (2025-12-11)**
    *   文档版本号与`智能日程与效能管理系统 v1.3.0`同步。
*   **v1.2.0 (2025-11-28)**
    *   更新了“多维表格最佳实践”中的API端点使用，明确了`get`操作。
*   **v1.0.0 (2025-11-09)**
    *   项目首个稳定版本发布。
    *   本文档作为 `智能日程与效能管理系统 v1.0.0` 的一部分，统一了版本号，并固化了经过验证的节点功能和操作名。
